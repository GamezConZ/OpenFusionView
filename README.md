...
* **Modern Interface:** "Material Dark" aesthetic based on FlatLaf with scalable SVG icons to minimize visual fatigue.
* **Internationalization:** Native support for 10 languages, including English, Spanish, Portuguese, French, Italian, German, Arabic, Hindi, Chinese, and Japanese.
...
**Option 1: Windows (Portable, no installation required - Recommended)**
No Java installation is required on your computer to use this version.

1. Go to the [Releases](https://github.com/GamezConZ/OpenFusionView/releases) tab.
2. Download and open the `OpenFusionView.exe` file.
...
2. Download the `OpenFusionView.jar` file from the [Releases](https://github.com/GamezConZ/OpenFusionView/releases) tab.
...
* **Interfaz Moderna:** Estética "Material Dark" basada en FlatLaf con íconos SVG escalables para minimizar la fatiga visual.
* **Internacionalización:** Soporte nativo para 10 idiomas, incluyendo Inglés, Español, Portugués, Francés, Italiano, Alemán, Árabe, Hindi, Chino y Japonés.
...
2. Descarga y abre el archivo `OpenFusionView.exe`.
...
2. Descarga el archivo `OpenFusionView.jar` desde la pestaña de [Releases](https://github.com/GamezConZ/OpenFusionView/releases).
